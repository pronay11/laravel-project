       ...
       <div class="container">
        <div class="row">
            ...
            <div class="form-group mt-2">
                ...
                <input type="text" value="{{$edit->des}}" name="des" class="form-control" >
            </div>
            <div class="form-group mt-2">
                <label for="price">Price</label>
                <input type="text" value="{{$edit->price}}" name="price" class="form-control" >
            </div>
            <div class="form-group mt-2">
                <label for="dis">Discount</label>
                <input type="text" value="{{$edit->dis}}" name="dis" class="form-control" >
            </div>
            <div class="form-select mt-2">
                <select value="{{$edit->status}}" name="status" class="form-select" id="">
                  <option value="1">Active</option>
                  <option value="2">Inactive</option>
                </select>    
            </div>
            <div class="form-group mt-2">
              <img src="{{ asset('backend/productimage/'.$edit->image) }}" height="100" alt="">
            </div>
            <div class="form-group mt-2">
