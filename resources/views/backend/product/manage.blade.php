       ...
       <table class="table">
            ...
            <tbody>
                ...
                @foreach($products as $product)
                    ...
                    <td><img src=" {{ asset('backend/productimage/'.$product->image) }} " alt="" height="40"></td>
                    <td><a class="btn btn-sm btn-info" href="{{route('product.edit',$product->id)}}">Edit</a>
                    <button data-bs-toggle="modal" data-bs-target="#delete{{ $product->id }}" class="btn btn-sm btn-danger" href="">Delete</button></td>
                    </tr>     
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-footer">
                            ...
                            <a type="button" href="{{ route('product.delete', $product->id) }}" class="btn btn-primary">Delete</a>
                        </div>
                        </div>
                    </div>
                    </div>            
